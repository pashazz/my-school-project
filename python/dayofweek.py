...
if __name__ == '__main__':
    ...
    parser.add_argument('curday', help='Текущий день года', metavar='K', type=int, choices=range(1,366))
    parser.add_argument('yearfirstday', help='Первый день недели в году', metavar='N', type=int, choices=range(1, 8))
